...
DELETE FROM address_pk_join;
DELETE FROM user_pk_join;
DELETE FROM user_bi_slave;
DELETE FROM address_bi_owner;
DELETE FROM many_to_one_bag;
DELETE FROM one_to_many_bag;
